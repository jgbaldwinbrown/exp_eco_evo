...
simple_test: simple_test.o simulator.o
	gcc -Wall -O3 -I/opt/local/include -L/opt/local/lib -lgsl -lgslcblas -lm $^ -o $@
...
unit_tests/unit_rinit_indiv: unit_tests/unit_rinit_indiv.o simulator.o
	gcc -Wall -O3 -I/Users/jbaldwin/Documents/git_repositories/exp_eco_evo -I/opt/local/include -L/opt/local/lib -lgsl -lgslcblas -lm $^ -o $@
...
unit_tests/unit_getshuf: unit_tests/unit_getshuf.o simulator.o
	gcc -Wall -O3 -I/Users/jbaldwin/Documents/git_repositories/exp_eco_evo -Wpedantic -I/opt/local/include -L/opt/local/lib -lgsl -lgslcblas -lm $^ -o $@
