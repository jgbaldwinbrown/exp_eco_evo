...
simple_test: simple_test.o simulator.o
	gcc -Wall -O3 -I/opt/local/include -L/opt/local/lib -lm $^ -o $@ -lgsl -lgslcblas
unit_tests/unit_rinit_indiv.o: unit_tests/unit_rinit_indiv.c
	gcc -Wall -O3 -I/Users/jbaldwin/Documents/git_repositories/exp_eco_evo -c $< -o $@
unit_tests/unit_rinit_indiv: unit_tests/unit_rinit_indiv.o simulator.o
	gcc -Wall -O3 -I/Users/jbaldwin/Documents/git_repositories/exp_eco_evo -I/opt/local/include -L/opt/local/lib -lm $^ -o $@ -lgsl -lgslcblas
unit_tests/unit_rinit_gen.o: unit_tests/unit_rinit_gen.c
	gcc -Wall -O3 -I/Users/jbaldwin/Documents/git_repositories/exp_eco_evo -I/opt/local/include -c $< -o $@
...
unit_tests/unit_getshuf: unit_tests/unit_getshuf.o simulator.o
	gcc -Wall -O3 -I/Users/jbaldwin/Documents/git_repositories/exp_eco_evo -Wpedantic -I/opt/local/include -L/opt/local/lib -lm $^ -o $@ -lgsl -lgslcblas
